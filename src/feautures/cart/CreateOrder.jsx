...
function CreateOrder() {
  ...
  const isSubmiting = navigation.state === "submit"
    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST" action="/order/new">
        <div className="mb-5 flex gap-2 flex-col sm:flex-row sm:items-center">
          ...
          <div className="grow"><input className="input  w-full" type="text" name="customer" required /></div>
        </div>
...
export async function action({ request }) {
  ...
  const errors = {}
  if (!isValidPhone(order.phone)) errors.phone = "Phone Num Error"
